...
export const validateBusinessDetails = (businessDetails) => {
  return {
    businessDetails: businessDetails.businessDetails
      ? ""
      : "Business Details are required.",
    additionalInformation: businessDetails.additionalInformation
      ? ""
...
export const validateContactInfo = (contactInfo) => {
  return {
    name: contactInfo.name ? "" : "Name is required.",
    designation: contactInfo.designation ? "" : "Designation is required.",
    role: contactInfo.role ? "" : "Role is required.",
    emailId: validateEmailId(contactInfo.emailId),
    contactNumber: validateMobileNumber(contactInfo.contactNumber),
  };
};

export const validateSocialDetails = (socialDetails) => {
  return {
    emailId: validateEmailId(socialDetails.emailId),
    contactNumber: validateMobileNumber(socialDetails.contactNumber),
  };
};

export const validateOtherDetails = (otherDetails) => {
  return {
    name: otherDetails.name ? "" : "Name is required.",
    address: otherDetails.address ? "" : "Address is required.",
  };
};
